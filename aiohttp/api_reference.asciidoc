...
[source, python]
----
envelope = await pubnub.publish().channels(string)\
    .message(object)\
    .should_store(bool)\
    .meta(dict)\
    .use_post(bool)\
...
# envelope.status.isError to see if error happened
----
...
[source, python]
----
await pubnub.here_now().channels(str|list|tuple).include_state(bool).include_uuids(bool).future()
----
